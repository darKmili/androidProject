...
public class Year1MarkerView extends MarkerView {

    private TextView tvContent;

    public Year1MarkerView(Context context, int layoutResource) {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        ...
        if (e instanceof CandleEntry) {
            ...
            long referenceTime = LineChartActivity.reFerenceTime/3600/24;
            long mTime = (referenceTime - (long)e.getX())*1000*3600*24;
